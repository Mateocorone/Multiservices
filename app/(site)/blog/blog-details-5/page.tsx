          ...
          <div className="w-full lg:w-2/3 mx-auto">
            <div className="animate_top rounded-md border border-stroke bg-white p-7.5 shadow-solid-13 dark:border-strokedark dark:bg-blacksection md:p-10">
              ...
              <h2 className="mb-5 mt-11 text-3xl font-semibold text-black dark:text-white 2xl:text-sectiontitle2">
                Estuco Veneziano: Lujo y Distinción
              </h2>
              ...
              <div className="blog-details space-y-4 text-black dark:text-white">
                <p>
                  Revestimientos artesanales que reflejan la luz y embellecen las superficies.
                </p>
                <p>
                  Ideales para espacios sofisticados como salones y escaleras.
                </p>
